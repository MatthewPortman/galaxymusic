...
#             
#         _MODULE_DIR = pj(os.getcwd(), "galfitlib")
#         
#         if not exists(_MODULE_DIR):
#             raise Exception("Could not find galfitlib!")
# 
...
class Fourier(GalfitComponent):
    ...
    def __init__(self, component_number, n = None, **kwargs):
        
        if n is None:
            n = {1 : (0.05, 45), 3 : (0.05, 25)}
        ...
        @amplitudes.setter
        def amplitudes(self, new_val):
            self._amplitudes = new_val
        ...
        @phase_angles.setter
        def phase_angles(self, new_val):
            self._phase_angles = new_val
...
class GalfitHeader(GalfitComponent):
    ...
    def __init__(self, parameters = None, galaxy_name = "", **kwargs):
...
if __name__ == "__main__":
    export_to_py("components", pj(LIBRARY_DIR, "classes", "components"))
