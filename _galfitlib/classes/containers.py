...
# ==========================================================================================================
    ...
    def check_component_types(self, input_dict = None):
...
class FeedmeContainer(ComponentContainer):
    def __init__(self, **kwargs):
        ...
        # TODO: This was commented before, does it affect operation if it is uncommented?
...
if __name__ == "__main__":
    export_to_py("containers", pj(LIBRARY_DIR, "classes", "containers"))
